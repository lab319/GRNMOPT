...
class MyProblem(ea.Problem): 
    ...
    def aimFunc(self, pop): # objective function
        ...
        for (alpha,time_lag) in zip(alphas,time_lag): 
            ...
            TS_data = pd.read_csv("GRNMOPT\DREAM4\insilico_size10\insilico_size10_1_timeseries.tsv", sep='\t').values
            SS_data_1 = pd.read_csv("GRNMOPT\DREAM4\insilico_size10\insilico_size10_1_knockouts.tsv", sep='\t').values
            SS_data_2 = pd.read_csv("GRNMOPT\DREAM4\insilico_size10\insilico_size10_1_knockdowns.tsv", sep='\t').values
            ...
            gold_edges = pd.read_csv("GRNMOPT\DREAM4\insilico_size10\insilico_size10_1_goldstandard.tsv", '\t', header=None)
